...
const Home = () => {
  ...
  return (
    <Box id = 'home' width='98%' height='auto' px='32px' m=' auto' display='grid' gridTemplateColumns='1fr' 
         rowGap='5%' justifyContent='center' color='black' gridTemplateRows='1fr'>

        <Box height='36rem' width='100%' display='grid' gap='1rem' justifyContent='center'
