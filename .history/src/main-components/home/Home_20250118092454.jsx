...
const Home = () => {
  console.log(i18next.t('logoDescription'))
    ...
    <Box width='100%' height='auto' px='32px' display='grid' gridTemplateColumns='1fr' 
          ...
          {/* ...... offers and download catalog......................................................... */}
            ...
            <Box width='100%' display='flex' flexWrap='wrap'>
                <Typography fontWeight='500' fontSize='40px' data-aos = 'fade-right' data-aos-delay="200">
                     <Typography color='green' display='inline' fontWeight='500' fontSize='40px'>Плетённая </Typography> 
        ...
        <Box width='100%' height={xlgScreen ? '5rem' : '3rem'} display='grid' gridTemplateColumns= { xlgScreen ? '2fr 1fr' : '1fr'}>
          <Box display='grid' gridTemplateColumns='repeat(3, 1fr)'>
             <Box display='flex' gap='0.5rem' alignItems='center' justifyContent='center' width='50%'>
