          ...
          {/* .......furnitures' images which offered.................................................... */}
            <Box height='100%' width='98%' display='grid' gridTemplateColumns={smScreen || mdScreen ? '1fr' : '2fr 1fr'} gap='5%' 
                ...
                <Box component='img' src={homeImages.img1} height='100%' width='100%' borderRadius='0.5rem'
                     data-aos = 'zoom-in'/>
                <Box height='100%' width='100%' display='grid' gridTemplateRows={smScreen || mdScreen ? '1fr' : '1fr 3fr'} 
                                                gap='5%'       gridTemplateColumns={smScreen || mdScreen ? '1fr 1fr' : '1fr'}>
                     <Box height='100%' width='100%' display='grid' gridTemplateColumns='1fr 1fr'>
