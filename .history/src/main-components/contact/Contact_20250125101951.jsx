...
const Contact = ({bbottom}) => {
  ...
  return (
    <Box id = {bbottom ? '#' : 'contacts'} position={bbottom ? 'fixed' : 'static'} top={bbottom ? '-20px' : '' } 
         zIndex='2'  px='12px' borderBottom={bbottom}>
        <Box height={smScreen ? '4rem' : xlgScreen ? '8rem' : 'auto'} width='100%' maxWidth='1440px' bgcolor='#FFFFFF'  color='black' p='1rem'  >
