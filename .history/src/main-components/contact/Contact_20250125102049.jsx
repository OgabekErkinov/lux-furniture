...
const Contact = ({bbottom}) => {
  ...
  return (
    <Box id = {bbottom ? '#' : 'contacts'} height={smScreen ? '4rem' : xlgScreen ? '8rem' : 'auto'} width='100%'  
         position={bbottom ? 'fixed' : 'static'} top={bbottom ? '-20px' : '' } 
         zIndex='2' maxWidth='1440px' px='auto' borderBottom={bbottom}>
