...
const Contact = () => {
  ...
  return (
    <Box height={xlgScreen ? '10rem' : 'auto'} width='100%'  position='fixed' top='-20px' zIndex='2' maxWidth='1780px' px='12px'>
       <Box height='100%' width='100%' bgcolor='#FFFFFF'  color='black' p='1rem' >
         <Box height='100%' width='100%' display='grid' alignItems='center' boxShadow = '0px 1px 0 rgba(0, 0, 0, 0.2)'
