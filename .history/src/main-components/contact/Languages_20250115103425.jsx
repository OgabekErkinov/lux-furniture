...
const Languages = () => {
    ...
    const buttonHeightWidth = {
      height : smScreen ? '1rem' : mdScreen ? '2rem' : '3rem',
    ...
    <Box display='flex' justifyContent='center'>
            {
              languages.map((language, idx) => {
                ...
                return (
                    <Button key={idx} onClick={()=>handleLanguage(language.name)} sx={buttonHeightWidth}>
                          <Box component='img' src={language.flag} borderRadius='2px' height='100%' width='100%' />
                    </Button>
