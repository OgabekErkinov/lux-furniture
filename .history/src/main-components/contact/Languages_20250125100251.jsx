...
const Languages = () => {
  ...
  return (
    <Box height='100%'  width='auto' ml={xlgScreen || lgScreen ? '3rem' : ''}>
              ...
              languages.map((language, idx) => {
                ...
                return (
                    <Box component='img' src={language.flag} borderRadius='2px' key={idx}
                         height={smScreen ? '24px' : mdScreen ? '32px' : lgScreen ? '40px' : '48px'}
                         width={smScreen ? '28px' : mdScreen ? '36px' : lgScreen ? '44px' : '52px'}
