...
const Contact = ({bbottom}) => {
  ...
  return (
    <Box height={xlgScreen ? '10rem' : 'auto'} width='100%'  position={bbottom ? 'fixed' : 'static'} top={bbottom ? '-20px' : '' } 
         zIndex='2' maxWidth='1440px' px='12px'>
       <Box height='100%' width='100%' bgcolor='#FFFFFF'  color='black' p='1rem' >
         <Box height='100%' width='100%' display='grid'  borderBottom={bbottom}
...
{/* ............Logo and mobile menu button, button is none when xlgScreens.................................. */}
        ...
        <Box  width='100%' display='grid' gridTemplateColumns={bbottom ? '1fr 1fr 1fr' : '' alignItems='center' pb='16px' >
