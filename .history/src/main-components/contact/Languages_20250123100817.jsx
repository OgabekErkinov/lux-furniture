...
const Languages = () => {
  ...
  return (
    <Box display='flex' justifyContent='center' alignItems='center' flexWrap='wrap' gap={smScreen ? '2px' : '0.5rem'} 
         height={smScreen ? '20px' : mdScreen ? '32px' : lgScreen ? '44px' : '48px'} width={smScreen ? '24px' : mdScreen ? '36px' : lgScreen ? '48px' : '52px'} >
            {
