  ...
  return (
    <Box width='80%' height='25rem' px='12px' color='black'>
      <Box height='100%' width='100%' display='flex' flexDirection='column' justifyContent='space-between'>
        ...
        {/* .................categories heading............................................... */}
        <Box width='50%' height='30%' display='flex' flexDirection='column' justifyContent='center' mx='auto' >
        ...
        <Box height = '40%' width = '100%' display='flex' alignItems='center' justifyContent='center'>
           <Box width='90%' height='100%' display='grid' gridTemplateColumns='repeat(4,1fr)' gap='1rem'>
           {
