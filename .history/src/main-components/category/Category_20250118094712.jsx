                    ...
                    return ( 
                      <Box height='100%' width='100%' position = 'relative' key={idx} borderRadius='0.5rem'
                         ...
                         <Stack height='100%' width='100%' bgcolor='rgba(92, 91, 92, 0.1)' justifyContent='flex-start' >
                            <Box display='flex' justifyContent='center' width='98%' height='10%' my='0.5rem' gap='0.2rem'>
                               <Typography fontSize='12px' color = '#FFFFFF' fontWeight='400'>{category?.name}</Typography>
