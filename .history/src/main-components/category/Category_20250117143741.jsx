...
const Category = () => {
  ...
  return (
    <Box width='70%' height='auto' px='12px' color='black'>
      <Box height='100%' width='100%' display='flex' flexDirection='column' justify gap='2rem'>

        {/* .................categories heading............................................... */}
        <Box width='50%' height='100%' display='flex' flexDirection='column' justifyContent='center' mx='auto' >
