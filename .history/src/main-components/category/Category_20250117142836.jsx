...
const Category = () => {
  ...
  return (
    <Box width='100%' height='auto' px='12px' color='black'>
      <Box height='100%' width='100%' display='grid' gridTemplateColumns='1fr' gridTemplateRows='1fr 2fr'>

        {/* .................categories heading............................................... */}
        <Box width='30%' height='100%' display='grid' gridTemplateRows='1fr 0.5fr' justifyContent='center' mx='auto' gap='5px'>
        ...
        <Box height = '100%' width = '100%' bgcolor='red' display='flex' alignItems='center' justifyContent='center'>
